...
int main() {
    ...
    glue({49, 49}, {0, 49}, {49, 149}, {0, 149});
    glue({0, 150}, {49, 150}, {0, 50}, {49, 50});
    glue({99, 49}, {50, 49}, {99, 99}, {50, 99});
    glue({50, 100}, {99, 100}, {50, 50}, {99, 50});
    glue({149, -1}, {100, -1}, {149, 99}, {100, 99});
    glue({100, 100}, {149, 100}, {100, 0}, {149, 0});
    glue({199, -1}, {150, -1}, {199, 49}, {150, 49});
    glue({150, 50}, {199, 50}, {150, 0}, {199, 0});

    glue({99, 0}, {99, 49}, {199, 0}, {199, 49});
    glue({200, 49}, {200, 0}, {100, 49}, {100, 0});
    glue({-1, 50}, {-1, 99}, {149, 50}, {149, 99});
    glue({150, 99}, {150, 50}, {0, 99}, {0, 50});
    glue({-1, 100}, {-1, 149}, {49, 100}, {49, 149});
    glue({50, 149}, {50, 100}, {0, 149}, {0, 100});
