...
os.system(f"curl -A \"github.com/richzli/advent-of-code-2022 via curl\" --cookie \"session={cookie}\" https://adventofcode.com/2022/day/{day}/input > {folder}/{day:02}.in")
open(f"{folder}/{day:02}.md", "w").write(
    markdownify(
        str(BeautifulSoup(
            str(subprocess.check_output(
                ["curl", "-A", "\"github.com/richzli/advent-of-code-2022 via curl\"", "--cookie", f"\"session={cookie}\"", f"https://adventofcode.com/2022/day/{day}"]
            ))
